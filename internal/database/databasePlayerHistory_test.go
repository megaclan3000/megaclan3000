		...
		},
		{
			...
			want: steamclient.PlayerHistory{
				...
				Data: []steamclient.PlayerHistoryEntry{
					{
						SteamID:                    "1",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 1, 0, time.UTC),
						TotalKills:                 "101",
						TotalADR:                   "102",
						TotalShotsHit:              "103",
						TotalShotsFired:            "104",
...

		{
			...
			want: steamclient.PlayerHistory{
				...
				Data: []steamclient.PlayerHistoryEntry{
					{
						SteamID:                    "2",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 2, 0, time.UTC),
						TotalKills:                 "201",
						TotalADR:                   "202",
						TotalShotsHit:              "203",
						TotalShotsFired:            "204",
...

		{
			...
			want: steamclient.PlayerHistory{
				...
				Data: []steamclient.PlayerHistoryEntry{
					{
						SteamID:                    "3",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 3, 0, time.UTC),
						TotalKills:                 "3013",
						TotalADR:                   "3023",
						TotalShotsHit:              "3033",
					...
					{
						SteamID:                    "3",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 4, 0, time.UTC),
						TotalKills:                 "30134",
						TotalADR:                   "30234",
						TotalShotsHit:              "30334",
					...
					{
						SteamID:                    "3",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 5, 0, time.UTC),
						TotalKills:                 "301",
						TotalADR:                   "302",
						TotalShotsHit:              "303",
						TotalShotsFired:            "304",
...

		{
			...
			want: steamclient.PlayerHistory{
				...
				Data: []steamclient.PlayerHistoryEntry{
					{
						SteamID:                    "4",
						Time:                       time.Date(2020, time.June, 23, 0, 0, 6, 0, time.UTC),
						TotalKills:                 "401",
						TotalADR:                   "402",
						TotalShotsHit:              "403",
						TotalShotsFired:            "404",
