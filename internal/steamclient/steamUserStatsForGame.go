...
func (sc *SteamClient) parseUserStatsForGame(data userStatsForGameData) (UserStatsForGame, error) {
	...
	return UserStatsForGame{
		...
		Stats: GameStats{
			...
			TotalHitsG3sg1:                            nilToZeroString(statsMap["total_hits_g3sg1"]),
			...
			TotalHitsM4a1:                             nilToZeroString(statsMap["total_hits_m4a1"]),
			TotalHitsMac10:                            nilToZeroString(statsMap["total_hits_mac10"]),
			TotalHitsMag7:                             nilToZeroString(statsMap["total_hits_mag7"]),
			TotalHitsMp7:                              nilToZeroString(statsMap["total_hits_mp7"]),
			TotalHitsMp9:                              nilToZeroString(statsMap["total_hits_mp9"]),
			...
			TotalHitsTec9:                             nilToZeroString(statsMap["total_hits_tec9"]),
			TotalHitsUmp45:                            nilToZeroString(statsMap["total_hits_ump45"]),
			TotalHitsXm1014:                           nilToZeroString(statsMap["total_hits_xm1014"]),
