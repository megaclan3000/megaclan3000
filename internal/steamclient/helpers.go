...
func divideNoZero(a, b int) string {

	if b == 0 {
		return "n/a"
	}

	return fmt.Sprintf("%.2f", float64(a)/float64(b)) // s == "123.456000"
}

func percentStringFloats(a, b int) string {
